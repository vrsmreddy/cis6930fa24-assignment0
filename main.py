...
class FBIApiHandler:
    ...
    def retrieve_data(self, page: int = 1):
        ...
        try:
            ...
            # Print any HTTP error that occurs during the API request
    ...
    def load_data_from_file(file_location: str):
        ...
        :param file_location: Path to the JSON file.
...
class WantedDataFormatter:
    ...
    def parse_data(records):
        ...
        """
        return (
            # Formatting the output as titleþsubjectsþfield_offices
            ...
            # Loop through each record in the 'items' list
...
class FBIWantedProgram:
    def __init__(self, page=None, file_location=None):
        ...
        :param page: Page number to retrieve from the FBI API.
        :param file_location: Path to a JSON file to load data from.
        """
        self.page = page
    ...
    def _get_data(self):
        ...
        :return: JSON data from either the API or the file.
        """
        # If the user provided a page number, fetch data from the API
        if self.page is not None:
            return self.api_handler.retrieve_data(self.page)
        # Otherwise, if a file location is provided, load the data from the file
        elif self.file_location is not None:
            return self.api_handler.load_data_from_file(self.file_location)
        # Return None if neither a page nor a file was provided
        else:
            return None
    ...
    def _display_output(self, formatted_output):
        ...
        :param formatted_output: Generator containing the formatted data.
        """
